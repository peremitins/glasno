...
После завершения текстовой interview session пользователь получает сохранённый отчёт: общий балл, критерии, разбор по вопросам, 3 главные правки, пример сильного ответа по STAR и PDF-экспорт.
